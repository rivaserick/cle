...
<nav class="navbar navbar-expand navbar-light justify-content-end">
        <div class="container"> <button class="navbar-toggler navbar-toggler-right border-0 ml-auto"
                type="button" data-toggle="collapse" data-target="#nav-docencia">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse text-center justify-content-center" id="nav-docencia">
                <ul class="navbar-nav">
                    <li class="nav-item mx-2">
                        <a class="btn btn-outline-primary btn-lg navbar-btn ml-md-2" href="{{route('docencia.actualizaciones.inicio')}}">
                            Actualizaciones
                        </a>
                    </li>
                </ul>
